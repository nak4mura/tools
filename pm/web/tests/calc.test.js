  ...
  workload: [
    {
      ...
      memberId: 'M001',
      processId: 'REQ',
      hours: { '2024/4': 40, '2024/5': 60, '2024/6': 20 },
    },
    {
      id: 'row_2',
      memberId: 'M001',
      processId: 'DEV',
      hours: { '2024/4': 80, '2024/5': 40 },
    },
    {
      id: 'row_3',
      memberId: 'M002',
      processId: 'DEV',
      hours: { '2024/4': 100, '2024/6': 50 },
    },
  ],
};
...
describe('getMemberMonthlyHours', () => {
  test('指定メンバー・月の合計時間を返す', () => {
    // M001 の 2024/4: REQ=40 + DEV=80 = 120
  ...
  test('複数工程の合算が正しい', () => {
    // M001 の 2024/5: REQ=60 + DEV=40 = 100
...
describe('getMemberTotal', () => {
  test('メンバーの全月・全工程合計を返す', () => {
    // M001: REQ(40+60+20) + DEV(80+40) = 120 + 120 = 240
...
describe('getProcessTotal', () => {
  test('工程の全メンバー・全月合計を返す', () => {
    // DEV: M001(80+40) + M002(100+50) = 120 + 150 = 270
...
describe('getMonthlyTotal', () => {
  test('指定月の全メンバー・全工程合計を返す', () => {
    // 2024/4: M001_REQ=40 + M001_DEV=80 + M002_DEV=100 = 220
...
describe('buildMemberSummary', () => {
  test('担当者別サマリーの形状が正しい', () => {
    ...
    assert.equal(summary.length, 2); // M001, M002
  });
  ...
  test('M001のREQ合計が正しい', () => {
    ...
    assert.ok(m001);
    assert.equal(m001.byProcess['REQ'], 40 + 60 + 20); // 120
  });
...
describe('buildProcessSummary', () => {
  test('工程別サマリーの形状が正しい', () => {
    ...
    assert.ok(Array.isArray(summary));
    assert.equal(summary.length, 2); // REQ, DEV
  });
  ...
  test('DEVの2024/4合計が正しい', () => {
    ...
    assert.ok(dev);
    // DEV 2024/4: M001=80 + M002=100 = 180
  ...
  test('全工程グランドトータルが全workload合計と一致する', () => {
    ...
    // M001_REQ(120) + M001_DEV(120) + M002_DEV(150) = 390
...
describe('isDuplicateRow', () => {
  ...
  test('自行を除外して検証する（編集時）', () => {
    // row_1 は M001+REQ だが、自行除外なので重複なし
